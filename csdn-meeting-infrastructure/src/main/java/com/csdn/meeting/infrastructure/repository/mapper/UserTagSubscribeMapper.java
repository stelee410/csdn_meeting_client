...
public interface UserTagSubscribeMapper extends BaseMapper<UserTagSubscribePO> {
    ...
    UserTagSubscribePO selectByUserIdAndTagId(@Param("userId") Long userId, @Param("tagId") Long tagId);
     ...
     * 分页查询用户订阅的标签
     */
    Page<UserTagSubscribePO> selectPageByUserId(Page<UserTagSubscribePO> page, @Param("userId") Long userId);
     ...
     */
    List<Long> selectSubscribedTagIdsByUserIdAndTagIds(@Param("userId") Long userId, @Param("tagIds") List<Long> tagIds);
