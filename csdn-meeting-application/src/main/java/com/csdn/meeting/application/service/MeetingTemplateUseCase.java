...
import com.csdn.meeting.application.util.CommaSeparatedNormalizer;
...
public class MeetingTemplateUseCase {
    ...
    private void applyUpdate(MeetingTemplate entity, MeetingTemplateDTO dto) {
        ...
        if (dto.getDefaultTags() != null) entity.setDefaultTags(CommaSeparatedNormalizer.normalize(dto.getDefaultTags()));
        if (dto.getTargetAudience() != null) entity.setTargetAudience(CommaSeparatedNormalizer.normalize(dto.getTargetAudience()));
    ...
    private MeetingTemplate toEntity(MeetingTemplateDTO dto) {
        ...
        e.setDefaultTags(CommaSeparatedNormalizer.normalize(dto.getDefaultTags()));
        e.setTargetAudience(CommaSeparatedNormalizer.normalize(dto.getTargetAudience()));
