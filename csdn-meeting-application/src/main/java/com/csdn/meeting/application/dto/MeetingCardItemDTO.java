...
public class MeetingCardItemDTO {
    ...
    @Schema(description = "会议形式编码", example = "1")
    ...
    @Schema(description = "会议类型编码", example = "1")
    ...
    @Schema(description = "会议场景编码", example = "1")
    ...
    // 发布时间
    @Schema(description = "发布时间", example = "2024-03-10T10:00:00")
