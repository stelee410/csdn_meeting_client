...
public class MeetingDetailDTO {
    ...
    @ApiModelProperty(value = "详细描述", example = "详细介绍...")
    ...
    @ApiModelProperty(value = "关联标签列表（包含订阅状态）")
    private List<MeetingTagDTO> tags;

    @ApiModelProperty(value = "创建时间", example = "2026-02-01 10:00:00")
    private LocalDateTime createTime;

    @ApiModelProperty(value = "更新时间", example = "2026-02-10 15:30:00")
