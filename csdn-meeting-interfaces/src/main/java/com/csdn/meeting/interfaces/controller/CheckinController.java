...
public class CheckinController {
    ...
    public ResponseEntity<CheckinQrDTO> generateCheckinCode(
    ...
    public ResponseEntity<CheckinQrDTO> getCheckinQrData(
            @Parameter(description = "会议ID", example = "M123456789")
            @PathVariable String meetingId) {
    ...
    public ResponseEntity<CheckinStatusResponse> getCheckinStatus(
            @Parameter(description = "会议ID", example = "M123456789")
